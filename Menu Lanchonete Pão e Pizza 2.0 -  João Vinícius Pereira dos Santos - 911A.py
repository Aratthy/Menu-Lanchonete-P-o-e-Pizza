...
def bebida():
  ...
  if PedidoBebida == 1: #Coca Cola Lata
    ...
    print(linha())
    print("A Sua Conta Ficou R$"f'{PreçoFinal2: .02f}', ". Obrigado Por Comer na Pão e Pizza, Volte Sempre.")
    print(linha())
...
def linha(tam = 42): #Função que faz as linhas
    return "-" * tam
...
if SuaOpçao == 1: #Sanduíches
  ...
  SeuPedido = int(input("Insira o Número Correspondente Ao Sanduíche Que Você Irá Querer? "))
  QuantasUnidades = int(input("Quantas Unidades Dele Você Vai Querer? "))
...
if SuaOpçao == 2: #Pizzas
  ...
  SeuPedido = int(input("Insira o Número Correspondente à Pizza Que Você Irá Querer? "))
